-- Complete schema snapshot at migration version 3.
-- Version 3 adds Rust-seeded starter Smart Rules only; it does not alter the
-- table shape from v2. The seed rows are installed by migrations.rs after the
-- category seed is available and remain ordinary editable user rows.
